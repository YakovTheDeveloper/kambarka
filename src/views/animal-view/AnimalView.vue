  ...
  <div class="container">
    ...
    <div class="center-3 block">
      ...
      <div class="row" :style="{ gap: '20px', alignItems: 'center' }">
        <img :src="getServerImageUrl(data?.blockFiveMedia?.image23)" alt=""
          :style="{ minWidth: '150px', width: '150px', height: '150px' }" class="round" />
        <p>
    ...
    <div class="right block">
      <div class="row" :style="{ justifyContent: 'space-between' }">
        ...
        <img v-if="data?.blockSixMedia?.image32" :src="getServerImageUrl(data?.blockSixMedia?.image32)" alt=""
          :style="{ width: '210px', minWidth: '210px', height: '210px' }" class="round" />
      </div>
      <Space value="50" />
      <div class="row" :style="{ justifyContent: 'space-between' }">
