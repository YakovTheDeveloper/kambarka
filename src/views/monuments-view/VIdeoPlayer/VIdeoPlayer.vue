<template>
  <div
    :class="[styles.castomVideo, className, isFullscreen ? styles.fullscreen : '']"
    ref="containerRef"
  ...
  >
    <div
      v-if="isFullscreen"
      :class="[styles.fullscreenHeader, showControls ? styles.visible : styles.hidden]"
    >
    ...
    <video
      ...
      ref="videoRef"
      :class="[styles.videoPlayer, IconVideo && !isFullscreen ? styles.videoPlayerFit : '']"
      :src="src"
      :poster="poster"
      @click="onVideoClick"
    />
